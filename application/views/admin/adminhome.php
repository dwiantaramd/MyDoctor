...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        ...
        <a id="pagetitle" class="navbar-brand" href="#">Administrator</a>
        <div class="dropdown show ml-auto">
            <a id="profil" class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img id="profile" class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60" height="50" width="50">
            </a>
    ...
    <div class="row no-gutters">
        <div id="sidebar" class="col-md-2 bg-dark pr-3 pt-4 pb-4">
            <ul class="nav flex-column">
                ...
                <li class="nav-item ml-2">
                    <a class="nav-link text-white" href="#"><i class="fas fa-hospital mr-2"></i>Hospital</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item ml-2">
                ...
                <li class="nav-item ml-2">
                    <a class="nav-link text-white" href="#"><i class="fas fa-notes-medical mr-2"></i>Specialist</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item ml-2">
